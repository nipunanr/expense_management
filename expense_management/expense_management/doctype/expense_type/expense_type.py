...
class ExpenseType(Document):
	def validate(self):
		...
		if self.default_account:
			...
			if account.account_type not in ["Expense Account", "Cost of Goods Sold"]:
				frappe.throw(f"Default Account must be an Expense Account or Cost of Goods Sold account")